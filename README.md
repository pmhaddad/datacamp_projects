...
and by enforcing handwashing at his hospital he saved hundreds of lives.<br/>
...
> [Click here](https://nbviewer.jupyter.org/github/pmhaddad/datacamp_projects/blob/master/python/4_exploring_the_evolution_of_linux/notebook.ipynb) to access a rendered version of the Jupyter notebook
...
patterns in nature. In this project, we will invent flowers using this fact.<br/>
This R project assumes you have familiarity with the `ggplot2` package. If you 
don't know `ggplot2` we recommend you take either of the courses **Introduction 
...
> [Click here](https://nbviewer.jupyter.org/github/pmhaddad/datacamp_projects/blob/master/r/1_phyllotaxis_draw_flowers_using_math/notebook.ipynb) to access a rendered version of the Jupyter notebook
...
> [Click here](https://nbviewer.jupyter.org/github/pmhaddad/datacamp_projects/blob/master/r/2_exploring_the_kaggle_data_science_survey/notebook.ipynb) to access a rendered version of the Jupyter notebook
...
> [Click here](https://nbviewer.jupyter.org/github/pmhaddad/datacamp_projects/blob/master/sql/2_what_and_where_are_the_worlds_oldest_businesses/notebook.ipynb) to access a rendered version of the Jupyter notebook
